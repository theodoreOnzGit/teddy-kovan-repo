...
| `literature/open/` | Small open documents kept with the folder itself |
...
private repository, fetch just the open corpus with
`git submodule update --init literature/open-corpus`.

Open the folder in Kovan (⚙ Setup, or Home → Open Kovan Folder).
